        ...
        <el-card :body-style="{ height: '100%' }">
          <fs-crud ref="crudRef" v-bind="crudBinding">
            <template #actionbar-right>
              <importExcel api="api/cmdb/device/" v-auth="'user:Import'">导入</importExcel>
            </template>
          </fs-crud>
        </el-card>
      </el-col>
...
import importExcel from '/src/components/importExcel/index.vue'
